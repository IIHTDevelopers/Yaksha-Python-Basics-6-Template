...
class TestRecipeManagement(unittest.TestCase):
    ...
    def test_calculate_total_cost(self):
        ...
        try:
            ...
            print(f"TestCalculateTotalCost = Failed | Exception: {e}")
    ...
    def test_normalize_quantities(self):
        ...
        try:
            ...
            print(f"TestNormalizeQuantities = Failed | Exception: {e}")
    ...
    def test_unique_ingredients(self):
        ...
        try:
            ...
            print(f"TestUniqueIngredients = Failed | Exception: {e}")
...
class TestSportsScorePrediction(unittest.TestCase):
    ...
    def test_predict_score(self):
        ...
        try:
            ...
            print(f"TestPredictScore = Failed | Exception: {e}")
    ...
    def test_save_predictions(self):
        ...
        try:
            ...
            print(f"TestSavePredictions = Failed | Exception: {e}")
...
class TestLoanManagement(unittest.TestCase):
    ...
    def test_display_loans(self):
        ...
        try:
            ...
            print(f"TestDisplayLoans = Failed | Exception: {e}")
    ...
    def test_find_highest_repayment(self):
        ...
        try:
            ...
            print(f"TestFindHighestRepayment = Failed | Exception: {e}")
